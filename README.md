...
| Shortcodes | Thirty-eight, and a render hook wherever plain Markdown can do the job instead |
...
| [Shortcodes](https://mortennordbye.github.io/northlight/docs/shortcodes/) | All thirty-eight, each running live on the page |
