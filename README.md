...
| Shortcodes | Twenty, and a render hook wherever plain Markdown can do the job instead |
...
| [Shortcodes](https://mortennordbye.github.io/northlight/docs/shortcodes/) | All twenty, each running live on the page |
