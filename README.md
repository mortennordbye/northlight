...
| Shortcodes | Thirty-four, and a render hook wherever plain Markdown can do the job instead |
...
| [Shortcodes](https://mortennordbye.github.io/northlight/docs/shortcodes/) | All thirty-four, each running live on the page |
