...
| Shortcodes | Twenty-one, and a render hook wherever plain Markdown can do the job instead |
...
| [Shortcodes](https://mortennordbye.github.io/northlight/docs/shortcodes/) | All twenty-one, each running live on the page |
